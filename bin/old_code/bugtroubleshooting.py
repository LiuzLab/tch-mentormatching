...
data = [{"Mentor Profile": file_name, "Mock Student CV": mock_cv, "PDF Text": pdf_text}]
df = pd.DataFrame(data)
df.to_csv("../simulated_data/mentor_student_cv_267825.csv", index=False)  # Change to .tsv if needed
