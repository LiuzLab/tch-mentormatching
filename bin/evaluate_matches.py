...
def evaluate_pair_with_llm(client, mentor_summary, mentee_summary, instructions=instructions):
    """
    ...
    combined_instructions = instructions + f"\n\nMentor Summary:\n{mentor_summary}\n\nMentee Summary:\n{mentee_summary}"
...
if __name__ == "__main__":
    ...
    evaluation = evaluate_pair_with_llm(client, mentor_summary_example, mentee_summary_example)
    print(evaluation)
