...
PATH_TO_MENTOR_DATA_RANKED = os.path.join(ROOT_DIR, "data/mentor_data_summaries_ranks.csv")
...
INDEX_SUMMARY_ASSISTANT_AND_ABOVE = os.path.join(ROOT_DIR, "db/index_summary_assistant_and_above")
INDEX_SUMMARY_ABOVE_ASSISTANT = os.path.join(ROOT_DIR, "db/index_summary_above_assistant")
